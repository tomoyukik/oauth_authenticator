...
class MauticAccessTokenHandler:
    ...
    def get_access_token(self):
        ...
        #     ('0.0.0.0', 8888),
        #     lambda request, address, server: HTTPServerHandler( # HTTPServerHandler呼び出し
        #         request, address, server, self._client_id, self._client_secret
        #     )
        # )
        # print('wrapping socket')
        # httpServer.socket = ctx.wrap_socket(httpServer.socket)
        # print('server created')
        # handled = httpServer.handle_request()
        # print(handled)
